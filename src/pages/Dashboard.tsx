    ...
    <div className="page-stack">
      ...
      <section className="latest-panel">
        ...
        <div className="latest-panel__facts">
          <div><span>Ímpares</span><strong>{latestMetrics.odd}</strong></div>
          <div><span>Soma</span><strong>{latestMetrics.sum}</strong></div>
          <div><span>Moldura</span><strong>{latestMetrics.frame}</strong></div>
      ...
      <section className="metric-strip" aria-label="Resumo da base">
        ...
        <div><GridFour size={20} /><span>Moldura média</span><strong>{aggregate.meanFrame.toFixed(1).replace('.', ',')}</strong></div>
