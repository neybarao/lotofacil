...
function LoadingScreen() {
  return <main className="state-screen"><div className="state-logo"><img className="brand-mark" src={`${import.meta.env.BASE_URL}icons/icon-192-v3.png`} alt="" /></div><div className="skeleton skeleton--title" /><div className="skeleton skeleton--copy" /><div className="skeleton skeleton--panel" /><p>Preparando as estatísticas…</p></main>
}
